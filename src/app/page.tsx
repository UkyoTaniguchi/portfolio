...
export default function Home() {
  return (
    <main className="md:h-screen w-full p-3 sm:p-8 md:p-12">
      <div className="hidden md:flex gap-2 h-full w-full p-8 border rounded-xl">
        <div className="h-full w-1/3">
          <div className="flex gap-3 h-1/4 w-full p-1">
            <div className="h-full w-1/2 border rounded-2xl hover:bg-[#232323] overflow-hidden">
              <Link
                href="https://github.com/UkyoTaniguchi"
            ...
            <div className="h-full w-1/2 border rounded-2xl hover:bg-[#232323] overflow-hidden">
              <Link
                href="https://x.com/Yoto4EYf8dP9X4y"
                className="flex h-full w-full justify-center items-center"
              >
            ...
            <div className="flex justify-center items-center h-full w-full border rounded-2xl p-2 hover:bg-[#232323]">
              ...
              >
                <div className="flex flex-col h-[90%] w-[90%]">
                  <h1 className="text-4xl font-bold text-center mb-3 p-3 border-b">
                    Projects
                  </h1>
        ...
        <div className="h-full w-1/3">
          <div className="flex gap-3 h-1/4 w-full p-1">
            <div className="h-full w-1/2 border rounded-2xl hover:bg-[#232323] overflow-hidden">
              <Link
                href="https://www.instagram.com/ukyou1121.tw/"
                className="flex h-full w-full justify-center items-center"
              >
            ...
            <div className="h-full w-1/2 border rounded-2xl hover:bg-[#232323] overflow-hidden">
              <Link
                href="https://www.figma.com/files/team/1379362410831578195/recents-and-sharing/recently-viewed?fuid=1379362408020278415"
                className="flex h-full w-full justify-center items-center"
              >
        ...
        <div className="h-full w-1/3">
          <div className="h-3/4 w-full p-1">
            <div className="flex justify-center items-center h-full w-full border rounded-2xl p-2 hover:bg-[#232323]">
              ...
              >
                <div className="flex flex-col h-[90%] w-[90%]">
                  <h1 className="text-4xl font-bold text-center mb-5 p-3 border-b">
                    The Study
                  </h1>
          ...
          <div className="flex gap-3 h-1/4 w-full p-1">
            <div className="h-full w-1/2 border rounded-2xl hover:bg-[#232323] overflow-hidden">
              <a
                href="mailto:ukyou.13.1121@icloud.com"
                className="flex h-full w-full justify-center items-center"
              >
      ...
      <div className="md:hidden">
        ...
        <div className="flex gap-3 w-full">
          <div className="relative w-1/2 border rounded-2xl hover:bg-[#232323] overflow-hidden">
            <a
              href="mailto:ukyou.13.1121@icloud.com"
              className="flex w-full justify-center items-center p-5 sm:16"
            >
