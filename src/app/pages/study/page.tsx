...
export default function Projects() {
    return(
        <div className="flex flex-col items-center w-full px-5 md:px-10 py-5">
            <div className="w-[90%] text-center text-xs sm:text-base md:text-xl p-5 mb-10 border-b">
                <h1 className="text-4xl sm:text-5xl font-bold mb-8">研究</h1>
                <p className="mb-4">北九州市立大学大学院 西田研究室</p>
                <p>西田研究室では，①協働ロボット，②グリッパ，③ケーブル艤装，④三次元計測，⑤動作計画，⑥リスクアセスメント，⑦無線通信に焦点を当てて研究しています．</p>
            </div>
            <div className="flex flex-col items-center w-full md:w-[90%] text-xs sm:text-base md:text-xl p-5 border-b">
                <h1 className="text-4xl sm:text-5xl font-bold mb-8">研究内容</h1>
                <p className="mb-10">私は主に，三次元計測に焦点を当てて研究しています．</p>
                <div className="w-full md:w-[90%] rounded-2xl px-3 md:px-24 py-4 shadow-inner shadow-[#0aafe6] mb-10">
                ...
                <div className="w-full md:w-[90%] rounded-2xl px-3 md:px-24 py-4 shadow-inner shadow-[#0aafe6]">
