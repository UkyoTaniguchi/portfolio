    ...
    return(
        <div className="flex flex-col items-center w-full px-10 py-5">
            ...
            <div className="flex flex-col items-center w-[80%] rounded-2xl px-4 py-10 shadow-inner shadow-[#FFD08A]">
                ...
                <div className="flex flex-col items-center w-[80%]">
                    <p className="text-xl text-center mb-4">2024/09　3Daysハッカソンでの作品を継続開発</p>
                    <div className="flex text-xl mb-4 w-full">
                        <p className="w-[105px] flex-shrink-0">担当箇所：</p>
