        ...
        <div className="w-full px-10 pt-5 pb-10">
            ...
            <div className="w-full flex flex-col items-center text-center text-lg md:text-2xl mt-8 border-b">
                ...
                <div className="mb-6 px-5 py-5 rounded-xl shadow-inner shadow-[#a7e9d0]">
                    <p className="text-2xl md:text-3xl font-bold text-[#daf6ff] mb-5">趣味</p>
                    <p>サウナ・キャンプ・釣り・山登り</p>
                </div>
                <div className="mb-6 px-5 py-5 rounded-xl shadow-inner shadow-[#a7e9d0]">
                    <p className="text-2xl md:text-3xl font-bold text-[#daf6ff] mb-5">学歴</p>
                    <p>2024/03　北九州市立大学 国際環境工学部 情報システム工学科 卒業</p>
                </div>
                <div className="mb-6 px-5 py-8 rounded-xl shadow-inner shadow-[#a7e9d0]">
                    <p className="text-2xl md:text-3xl font-bold text-[#daf6ff] mb-5">言語・スキル</p>
                ...
                <div className="flex flex-col items-center mb-6 px-5 py-10 rounded-xl shadow-inner shadow-[#a7e9d0]">
                    <p className="text-2xl md:text-3xl font-bold text-[#daf6ff] mb-5">実績・受賞歴</p>
